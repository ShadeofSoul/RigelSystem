...
const ProductComments = () => {
  ...
  const whoIsAuthor = (commentixx) => {
    if (user && commentixx.user === user.email) {
      return true;
    } else {
      return false;
    }
                ...
                <div style={marginOfComment(item)}>
                  <div className='grid grid-cols-12'>
                    <img
                      width='40px'
                      height='40px'
                      className='rounded-full mr-4 my-5 col-span-1'
                      src='https://media.istockphoto.com/vectors/anonymous-vector-icon-incognito-sign-privacy-concept-human-head-with-vector-id1284693553?b=1&k=6&m=1284693553&s=170667a&w=0&h=rI4q3TyAdLUHEYuQk6BxeryAjaNTUQpMIx8gB76VSfc='
                    ...
                    <div className='my-5 col-span-11 '>
                      ...
                      <p className='text-white text-xl'>{item.commit}</p>
                    </div>
                  </div>
                  {whoIsAuthor(item) ? (
                    <button
